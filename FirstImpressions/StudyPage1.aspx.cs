...
namespace FirstImpressions
{
    public partial class StudyPage1 : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (Convert.ToString(Session["Gender"]) == "Male")
            {
                ...
                if (Convert.ToInt32(Session["NumberofPictures"]) == 3)
                {
                    ...
                    Image4.ImageUrl = "https://github.com/contactaditya/FirstImpressions/tree/master/FirstImpressions/Pictures/" + picturename + ".jpg";
                    Image5.ImageUrl = "https://github.com/contactaditya/FirstImpressions/tree/master/FirstImpressions/Pictures/" + picturename1 + ".jpg";
                    Image6.ImageUrl = "https://github.com/contactaditya/FirstImpressions/tree/master/FirstImpressions/Pictures/" + picturename2 + ".jpg";
        ...
        if (Convert.ToInt32(Session["NumberofPictures"]) == 4)
         ...
         Image7.ImageUrl = "https://github.com/contactaditya/FirstImpressions/tree/master/FirstImpressions/Pictures/" + picturename + ".jpg";
         Image8.ImageUrl = "https://github.com/contactaditya/FirstImpressions/tree/master/FirstImpressions/Pictures/" + picturename1 + ".jpg";
         Image9.ImageUrl = "https://github.com/contactaditya/FirstImpressions/tree/master/FirstImpressions/Pictures/" + picturename2 + ".jpg";
         Image10.ImageUrl = "https://github.com/contactaditya/FirstImpressions/tree/master/FirstImpressions/Pictures/" + picturename3 + ".jpg";
         ...
         if (conditions == 4 && conditions1 == 4 && conditions2 == 4 && conditions3 == 4)
         {
            ...
            else
            {
                ...
                if (Convert.ToInt32(Session["NumberofPictures"]) == 1)
                {
                    ...
                    string picturename = (string)PictureName1[0];
                    int conditions = (int)Condition1[0];
                    Image1.ImageUrl = "https://github.com/contactaditya/FirstImpressions/tree/master/FirstImpressions/Pictures/" + picturename + ".jpg";
                ...
                if (Convert.ToInt32(Session["NumberofPictures"]) == 2)
                {
                    ...
                    Image2.ImageUrl = "https://github.com/contactaditya/FirstImpressions/tree/master/FirstImpressions/Pictures/" + picturename + ".jpg";
                    Image3.ImageUrl = "https://github.com/contactaditya/FirstImpressions/tree/master/FirstImpressions/Pictures/" + picturename1 + ".jpg";
        ...
        protected void btnSubmit1_Click(object sender, EventArgs e)
        {
            ...
            if (result == 1)
            {
                ScriptManager.RegisterStartupScript(this, GetType(), "showAlert", "alert('Your ratings have been successfully submitted.');location.href='StudyPage2.aspx'", true);
            }
        }
