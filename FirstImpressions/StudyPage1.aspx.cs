...
namespace FirstImpressions
{
    public partial class StudyPage1 : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (Convert.ToString(Session["Gender"]) == "Male")
            {
                ...
                if (Convert.ToInt32(Session["NumberofPictures"]) == 1)
                {
                    ...
                    Image1.ImageUrl = "https://firstimpressions.scm.azurewebsites.net/api/vfs/site/wwwroot/Pictures/" + picturename + ".jpg";
                ...
                if (Convert.ToInt32(Session["NumberofPictures"]) == 2)
                {
                    ...
                    Image2.ImageUrl = "https://firstimpressions.scm.azurewebsites.net/api/vfs/site/wwwroot/Pictures/" + picturename + ".jpg";
                    Image3.ImageUrl = "https://firstimpressions.scm.azurewebsites.net/api/vfs/site/wwwroot/Pictures/" + picturename1 + ".jpg";
                ...
                if (Convert.ToInt32(Session["NumberofPictures"]) == 3)
                {
                    ...
                    Image4.ImageUrl = "https://firstimpressions.scm.azurewebsites.net/api/vfs/site/wwwroot/Pictures/" + picturename + ".jpg";
                    Image5.ImageUrl = "https://firstimpressions.scm.azurewebsites.net/api/vfs/site/wwwroot/Pictures/" + picturename1 + ".jpg";
                    Image6.ImageUrl = "https://firstimpressions.scm.azurewebsites.net/api/vfs/site/wwwroot/Pictures/" + picturename2 + ".jpg";
        ...
        if (Convert.ToInt32(Session["NumberofPictures"]) == 4)
         ...
         Image7.ImageUrl = "https://firstimpressions.scm.azurewebsites.net/api/vfs/site/wwwroot/Pictures/" + picturename + ".jpg";
         Image8.ImageUrl = "https://firstimpressions.scm.azurewebsites.net/api/vfs/site/wwwroot/Pictures/" + picturename1 + ".jpg";
         Image9.ImageUrl = "https://firstimpressions.scm.azurewebsites.net/api/vfs/site/wwwroot/Pictures/" + picturename2 + ".jpg";
         Image10.ImageUrl = "https://firstimpressions.scm.azurewebsites.net/api/vfs/site/wwwroot/Pictures/" + picturename3 + ".jpg";
